...
import com.zbsnetwork.zbsjava.transactions.LeaseTransactionV2;
...
public class IntegrationTransactionsTest {
    ...
    public void test() {
        ...
        check(Transactions.makeMassTransferTx(acc, Asset.ZBS, transfers, SMALL_FEE, "mass transfer"));
        ...
        data.add(new DataEntry.StringEntry("My Poem", "Oh 0bs!"));
    ...
    private <T extends Transaction> void checkSend(T tx, String failure, String message) {
        try {
            ...
            assertTrue(true); //todo: Change asset ID's to match network
